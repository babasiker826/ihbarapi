...
# ESKİ API URL'LERİ (SADECE ESKİLER)
...
# -----------------------------------------------------------
# SULALE PRO FONKSİYONU (ESKİ API İLE)
# -----------------------------------------------------------
...
# -----------------------------------------------------------
# TC PRO FONKSİYONU (ESKİ API İLE)
# -----------------------------------------------------------
...
if __name__ == '__main__':
    ...
    print("   - /iban_sorgulama, /iban_dogrulama, /iban_banka_kodlari")
    print("📡 API URL'leri:")
