...
# Telethon konfigürasyonu (YENİ SESSION)
API_ID = 17570480
...
# API URL'leri (YENİ URL'LER)
SULALE_API = "https://demirkoc.alwaysdata.net/Api/sulale.php?tc="
ADRES_API = "https://demirkoc.alwaysdata.net/Api/adres.php?tc="
TCGSM_API = "https://demirkoc.alwaysdata.net/Api/tcgsm.php?tc="
AILE_API = "https://demirkoc.alwaysdata.net/Api/aile.php?tc="
...
# -----------------------------------------------------------
# SULALE PRO FONKSİYONU (YENİ URL İLE)
# -----------------------------------------------------------
...
async def aile_pro_query(tc):
    ...
    async with aiohttp.ClientSession() as session:
        try:
            ...
            # Ham veriyi kaydet
            results["ham_aile_verisi"] = clean_json_data(aile_data)
            
            # 2. TC'leri çıkar
            tc_list = extract_tc_numbers(aile_data)
            tc_list = [t for t in tc_list if t.isdigit() and len(t) == 11]
